...
<div id="reporteTIPI" style="width: 97%; margin-left: 20px; display: block;">
        <div class="form-group row justify-content-between" style="margin: 10px; padding:10px;">
	      <a id="vlv"  href="reporteincidentes.php" class="col-1 vlv btn btn-primary" type="button"  value="VOLVER"><i class="fa-solid fa-arrow-left"></i></a>
							...
							#si la column tipificacion esta vacia se carga el mensaje "SIN TIPIFICACION"
							 ...
							 #SE carga en la tabla html los valores obtenidos de la consulta en cada fila correspondiendo a cada tipificacion
									...
									<tr style='border-bottom: solid 1px #073256;'>
										...
										<td class='text-center text-nowrap cabe'  style='width: 80px;'><a class='btn btn-sm btn-outline-primary' href='../consulta/detalletipincidentes.php?Tipificacion=".$listar['ID_TIPIFICACION']."&desde=$fechadesde&hasta=$fechahasta' class=mod><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentcolor' margin='5' class='bi bi-eye' viewBox='0 0 16 16'>
