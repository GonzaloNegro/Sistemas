...
// <form method='POST' action='detalleestadoincidentes.php'>
									...
									"   <input type='hidden' name='fechdesde' value='".$fechadesde."' />
										...
										<td class='text-center text-nowrap cabe'  style='width: 80px;'><a class='btn btn-sm btn-outline-primary' href='../consulta/detalleestadoincidentes.php?Estado=".$listar['ID_ESTADO']."&desde=$fechadesde&hasta=$fechahasta' class=mod><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentcolor' margin='5' class='bi bi-eye' viewBox='0 0 16 16'>
