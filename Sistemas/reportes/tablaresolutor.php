...
<div id="reporreso" style="width: 97%; margin-left: 20px; display: block;">
	   ...
	   <div class="form-group row justify-content-between" style="margin: 10px; padding:10px;">
	      <a id="vlv"  href="reporteincidentes.php" class="col-3 btn btn-primary " type="button"  value="VOLVER"><i class="fa-solid fa-arrow-left"></i></a>
						...
						if ($listar['RESOLUTOR']== null) {
							...
							$nombre = $listar['RESOLUTOR'];
									...
									"
										...
										<td class='text-center text-nowrap cabe'  style='width: 80px;'><a class='btn btn-sm btn-outline-primary' href='../consulta/detalleresoincidentes.php?Reso=".$listar['ID_RESOLUTOR']."&desde=$fechadesde&hasta=$fechahasta' class=mod><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentcolor' margin='5' class='bi bi-eye' viewBox='0 0 16 16'>
