                ...
                $.ajax({
                    ...
                    success: function (respuesta) {
                        ...
                        respuesta.datos.forEach(fila => {
                            ...
                            tabla.append(`<tr>
                                <td><h4 style='font-size:14px; text-align:center;margin-right: 5px;'>${fila.MODELO}</h4></td>
                                <td><h4 style='font-size:14px; text-align:center;'>${fila.NOMBRE}</h4></td>
                                ...
                                <td><h4 style='font-size:14px; text-align:left;margin-right: 5px;'>${fila.SERIEG}</h4></td>
