...
<body>
        ...
        <div id="mostrar_reporte" style="width: 97%; margin-left: 20px; display: block;">
		            ...
		            <div class="form-group row justify-content-between" style="margin: 10px; padding:10px;">
	                    <a id="vlv"  href="../reportes/reporteincidentes.php" class="col-3 btn btn-primary " type="button"  value="VOLVER"><i class="fa-solid fa-arrow-left"></i></a>
			        ...
			        <?php
					    ...
					    $tipificacion = $_GET['Tipificacion'];
						if ($tipificacion==0) {
							$tit="S/A";
						}
						else {
							$consularea=mysqli_query($datos_base, "select a.TIPIFICACION from tipificacion a where a.ID_TIPIFICACION=$tipificacion");
						    $consultit=mysqli_fetch_array($consularea);
							$tit=$consultit['TIPIFICACION'];
						}
                        $conttotal=mysqli_query($datos_base, "SELECT COUNT(*) as TOTAL from ticket t where t.ID_TIPIFICACION=$tipificacion and t.FECHA_INICIO between '$fechadesde' and '$fechahasta'");
						...
						echo "
						<h1 id='titulo'>REPORTE DE INCIDENTES POR TIPIFICACION:".$tit."</h1>
						...
						where t.ID_TIPIFICACION=$tipificacion and t.FECHA_INICIO between '$fechadesde' and '$fechahasta'
