        ...
        <div id="mostrar_reporte" style="width: 97%; margin-left: 20px; display: block;">
			        ...
			        <?php
						...
						if ($resolutor==0) {
							...
							$consularea=mysqli_query($datos_base, "select a.RESOLUTOR from resolutor a where a.ID_RESOLUTOR=$resolutor");
						 $consultit=mysqli_fetch_array($consularea);
							$tit=$consultit['RESOLUTOR'];
						}
                        $conttotal=mysqli_query($datos_base, "SELECT COUNT(*) as TOTAL from ticket t where t.ID_RESOLUTOR= $resolutor and t.FECHA_INICIO between '$fechadesde' and '$fechahasta'");
						...
						echo "
						<h1 id='titulo'>REPORTE DE INCIDENTES POR RESOLUTOR:".$tit."</h1>
						...
						where t.ID_RESOLUTOR= $resolutor and t.FECHA_INICIO between '$fechadesde' and '$fechahasta'
