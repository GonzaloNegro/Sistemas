...
<script type="text/javascript">
			function ok(){
				swal(  {title: "Modelo cargado correctamente",
						icon: "success",
...
<script type="text/javascript">
			function repeat(){
				swal(  {title: "Modelo cargado correctamente. Verifique el nombre del modelo, ya que existe este nombre registrado previamente!",
						icon: "info",
						})
						.then((confirmar) => {
						if (confirmar) {
...
<script type="text/javascript">
			function no(){
				swal(  {title: "El modelo de la marca ingresada ya está registrado",
						icon: "error",
						})
						.then((confirmar) => {
						if (confirmar) {
	...
	<div id="reporteEst" style="width: 97%; margin-left: 20px;">   
		...
		<div id="principalu" style="width: 97%" class="container-fluid" data-aos="zoom-in">
						<form method="POST" action="guardarmodelo.php">
                            ...
                            <input class="form-control col-xl col-lg" style=text-transform:uppercase; type="text" name="modelo" placeholder="NOMBRE DEL MODELO" required>
                            </div>
