...
<head>
	...
	<link rel="stylesheet" type="text/css" href="estiloagregararea.css">
...
<div class="container-fluid">
  ...
  <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
	...
	<input type="checkbox" id="btn-menu">
        ...
        <section id="Inicio">
		<div id="titulo" style="">
			<h1 style="font-size: 32px;">AGREGAR ÁREA</h1>
		</div>
        <div id="principal" style="width: auto" class="container-fluid">
						<form method="POST" action="cargaarea.php">
						<div class="form-group row" style="margin: 10px; padding:10px;">
						    <label style="font-size: 30px;" id="lblForm"class="col-form-label col-xl col-lg">NOMBRE DEL ÁREA:</label>
							<input style="margin-top: 5px"class="form-control col-form-label col-xl col-lg" type="text" name="area" placeholder="NOMBRE DEL ÁREA" required>
				        </div>	
						<div class="form-group row justify-content-end" style="margin: 10px; padding:10px;">
							<input style="width:20%"class="col-3 button" type="submit" value="GUARDAR ÁREA" class="button">
				        </div>	
					</form>
			<?php
				if(isset($_GET['ok'])){
					echo "<h3>Área cargada</h3>";
				}
			?>
		</div>
	</section>
