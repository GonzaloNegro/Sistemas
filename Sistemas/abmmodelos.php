    ...
    <section id="inicio">
        <div id="reporteEst" style="width: 97%; margin-left: 20px;">   
            <div class="form-group row justify-content-between" style="margin: 10px; padding:10px;">
                ...
                <a id="agr"  href="agregarmodelo.php" class="col-3 btn btn-primary " type="button">AGREGAR MODELO</a>
            </div>					
         </div>
								...
								while($listar = mysqli_fetch_array($consultar))
								{
									...
									" 
										<tr>
											...
											<td class='text-center text-nowrap'><a class='btn btn-sm btn-outline-primary' href=modmodelos.php?no=".$listar['ID_MODELO']." class=mod><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
