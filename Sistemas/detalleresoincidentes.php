...
<body>
        ...
        <div id="mostrar_reporte" style="width: 97%; margin-left: 20px; display: block;">
			        ...
			        <?php
						...
						LEFT JOIN resolutor r ON r.ID_RESOLUTOR = t.ID_RESOLUTOR left join tipificacion i on t.ID_TIPIFICACION=i.ID_TIPIFICACION where t.ID_RESOLUTOR= $resolutor and t.FECHA_INICIO between '$fechadesde' and '$fechahasta'
