					    ...
					    group by e.ESTADO");
									while($listar = mysqli_fetch_array($consultar))
									{
										...
										"
											...
											<td id='accion' class='text-center text-nowrap'><a class='btn btn-sm btn-outline-primary' href=reporteestadoequipo.php?Estado=".$listar['ID_ESTADOWS']."&Repa=0 class=mod><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentcolor' margin='5' class='bi bi-eye' viewBox='0 0 16 16'>
