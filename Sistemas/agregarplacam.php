...
<script type="text/javascript">
			function ok(){
				swal(  {title: "Placa madre cargada correctamente",
						icon: "success",
...
<script type="text/javascript">
			function repeat(){
				swal(  {title: "Palaca madre cargada correctamente. Verifique el nombre de la marca, ya que existe este nombre registrado previamente!",
						icon: "info",
						})
						.then((confirmar) => {
						if (confirmar) {
...
<script type="text/javascript">
			function no(){
				swal(  {title: "La placa madre de la marca ingresada ya está registrada",
						icon: "error",
						})
						.then((confirmar) => {
						if (confirmar) {
	...
	<div id="reporteEst" style="width: 97%; margin-left: 20px;">   
				<div class="form-group row justify-content-between" style="margin: 10px; padding:10px;">
					<a id="vlv"  href="abmplacamadre.php" class="col-3 btn btn-primary " type="button"  value="VOLVER">VOLVER</a>
				</div>					
		</div>
		...
		<div id="principalu" style="width: 97%" class="container-fluid" data-aos="zoom-in">
						<form method="POST" action="guardarmodplacam.php">
                            <div class="form-group row" style="margin: 10px; padding:10px;">
                                ...
                                <input class="form-control col-xl col-lg" style="text-transform:uppercase;" type="text" name="placam" placeholder="NOMBRE DEL MODELO" required>
