    ...
    <div class="bienvenida" data-aos="zoom-in-up">
        ...
        <div class="info">
            <ul class="list-unstyled">
                <li>
                    <ul>
                        <li>SE HA AGREGADO EL BOTÓN DE ACCESO AL MANUAL Y SE ENCUENTRA EN LA PARTE SUPERIOR EN EL ICONO FINAL.</li>
    <!--                       <li>SE INCORPORÓ LA PANTALLA DE "CONSULTAS PARA ALTAS"</li>
        ...
        <div class="btn">
            <div class="form-group row justify-content-between" style="margin: 10px; padding:10px;">
                <a id="vlv"  href="../consulta/consulta.php" class="col-3 btn btn-primary " type="button"  value="VOLVER">CERRAR</a>
            </div>	
        </div>
    </div>
    <footer>
