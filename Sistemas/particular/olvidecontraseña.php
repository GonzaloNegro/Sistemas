...
<body>
			...
			function done(){
				swal("Constraseña cambiada!", "Se ha reestablecido a una por defecto", "success");
			}	</script>
			<script>
			function error(){
	...
	<section id="ingreso"> 
		<div id="ingresar" style="width: 350px; height: 320px;" class="container-fluid">
			<form method="POST" action="reestablecerpwd.php">
				<div class="form-group row" style="margin-top:10px; margin-left:5px; margin-right:5px;"><h3 style="padding:10px;">RECUPERAR CONTRASEÑA</h3></div>
