...
<script type="text/javascript">
			function ok(){
				swal(  {title: "Periférico cargado correctamente",
						icon: "success",
...
<script type="text/javascript">
		...
		<div id="reporteEst" style="width: 97%; margin-left: 20px;">
				<div class="form-group row justify-content-between" style="margin: 10px; padding:10px;">
					<a id="vlv"  href="abmotros.php" class="col-3 btn btn-primary "  type="button"  value="VOLVER">VOLVER</a>
				</div>					
		</div>
	<section id="Inicio">
		...
		<div id="principale" style="width: auto" class="container-fluid" data-aos="zoom-in">
                        ...
                        <label id="lblForm"class="col-form-label col-xl col-lg">TIPO PERIFÉRICO:</label>
                            <select name="tipop" style="text-transform:uppercase" class="form-control col-xl col-lg" required>
                                    ...
                                    <?php
                                    include("conexion.php");
                                    $consulta= "SELECT * FROM tipop WHERE ID_TIPOP = 5 OR ID_TIPOP = 6 OR ID_TIPOP = 9 OR ID_TIPOP = 11 OR ID_TIPOP = 12";
