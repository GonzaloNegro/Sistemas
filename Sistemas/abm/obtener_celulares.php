...
$consulta = "SELECT * FROM celular l INNER JOIN lineacelular c ON c.ID_CELULAR=l.ID_CELULAR INNER JOIN modelo m ON l.ID_MODELO=m.ID_MODELO WHERE c.ID_USUARIO=$usuario AND c.ID_LINEA=0";
