	...
	<script>
		...
		["ok","okMod","no","noMod"].forEach(param => {
			if (urlParams.has(param)) {
				switch(param) {
					case "ok":
						showAlert("Área agregada correctamente.", "success");
						break;
					case "okMod":
						showAlert("Área modificada correctamente.", "success");
						break;
					case "no":
						showAlert("El área ingresada ya está registrada.", "error");
						break;
					case "noMod":
						showAlert("No se ha podido modificar el área. Ya se encuentra registrada.", "error");
						break;
				}
			}
		});
