    ...
    <section id="inicio">
        ...
        <?php
				echo "<table width=100%>
					...
					{
						$doc = $_POST['buscar'];
						$consultar=mysqli_query($datos_base, "SELECT p.ID_PERI, a.AREA, r.REPA, u.NOMBRE, p.SERIEG, mo.MODELO, t.TIPO, m.MARCA			
						FROM periferico p 
						...
						AND (a.AREA LIKE '%$doc%' OR r.REPA LIKE '%$doc%' OR u.NOMBRE LIKE '%$doc%' OR p.SERIEG LIKE '%$doc%' OR mo.MODELO LIKE '%$doc%' OR t.TIPO LIKE '%$doc%' OR m.MARCA LIKE '%$doc%'))
