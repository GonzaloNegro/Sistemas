...
<body>
<header  class="header" style="width: 100%;  height: 60px;">
<div class="container-fluid">
  ...
  <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
	...
	<input type="checkbox" id="btn-menu">
		...
		<div id="principal" style="width: 97%" class="container-fluid">
						<form method="POST" action="cargadeusuario.php">
                            <div class="form-group row" style="margin: 10px; padding:10px;">
							<label id="lblForm" class="col-form-label col-xl col-lg">USUARIO:</label>
                            <input class="form-control col-xl col-lg" type="text" name="nombre_usuario" placeholder="NOMBRE USUARIO" required>
                            ...
                            <select name="area" class="form-control col-xl col-lg">
                            ...
                            <input style="width: 20%;"class="col-3 button" type="submit" value="GUARDAR USUARIO" >
                            </div>
					</form>
				<?php
				if(isset($_GET['ok'])){
					echo "<h3>Usuario cargado</h3>";
				}
				?>
		</div>
	</section>
