...
<head>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="estiloconsultadetalleimp.css">
...
<body>
	...
	<section id="ingreso">
            ...
            <div id="volver">
			    <a id="vlv" href="impresoras.php" class="btn btn-primary">VOLVER</a>
		    </div><br>
	</section>
</body>
</html>