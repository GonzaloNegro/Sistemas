...
<head>
	...
	<link rel="stylesheet" type="text/css" href="estilomonitores.css">
								...
								WHERE p.TIPOP LIKE '%MONITOR%'
									...
									while($listar = mysqli_fetch_array($consultar))
									{
										...
										" 
											...
											<td class='text-center text-nowrap'><a class='btn btn-sm btn-outline-primary' href=consultadetallemon.php?no=".$listar['ID_PERI']." class=mod><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentcolor' margin='5' class='bi bi-eye' viewBox='0 0 16 16'>
